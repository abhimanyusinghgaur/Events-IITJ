...
if($query_run = mysql_query($query))
{
	...
	else
	{
		...
		echo "<div id='events'><table class='striped' border='1' style='font-size:1.5em;'><thead><tr><th>ID</th><th>Event Name</th><th>Time</th><th>Description</th><th>Tags</th><th colspan='3'>Approve/Disapprove</th></tr></thead><tbody>";
		while($query_row = mysql_fetch_assoc($query_run))
		{
			$ID = $query_row['id'];
		...
		echo "<tr><td colspan='8' style='text-align:right;'><input type='submit' name='submit' value='Submit'></td></tr>";
